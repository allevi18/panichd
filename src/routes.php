<?php
Route::group(['prefix' => LaravelLocalization::setLocale(),'middleware' => ['jailBanned', 'throttle:web', 'web', 'auth']], function () use ($main_route, $main_route_path, $admin_route, $admin_route_path) {
    // Notice list
