		...
		<div class="card-body">
			<table class="table table-hover table-striped">
				...
				@foreach ($a_notices as $notice)
					...
					@if($u->currentLevel() > 1)
						<td><span title="{{ $u->currentLevel() > 2 ? trans('panichd::lang.show-ticket-creator') . trans('panichd::lang.colon') . $notice->owner->name : '' }}">{{ $notice->owner->panichd_department == 0 ? trans('panichd::lang.all-depts') : $notice->owner->userDepartment->resume(true) }}</span></td>
					@endif
					<td>
